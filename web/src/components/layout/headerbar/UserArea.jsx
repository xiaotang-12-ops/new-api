...
const UserArea = ({
  ...
  const canAccessPersonal =
    !sidebarLoading && isModuleVisible('personal', 'personal');
  const canAccessToken = !sidebarLoading && isModuleVisible('console', 'token');
  const canAccessTopup = !sidebarLoading && isModuleVisible('personal', 'topup');
